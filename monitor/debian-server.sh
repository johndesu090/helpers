#!/bin/bash
# Author: JohnFordTV <admin@johnfordtv.me>
...
info "Welcome to SSHPanel & VPNPanel configuration script."
enter
echo "JohnFordTV"
echo "--------"
...
if [ ${__PHP__} -eq 1 ]; then
    ...
    if [ ${__CODENAME__} = 'stretch' ]; then 
        sudo sudo apt-get install php7.0 php7.0-xml php7.0-mbstring php7.0-zip libapache2-mod-php7.0 -y
    else
